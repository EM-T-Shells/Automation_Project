...
Feature: AddMoons
	...
	a valid moon name and planet, a user should be able to add a new moon to the Planetarium
	...
	a moon name with exactly 30 characters, a user should be able to add a new moon
		Given The user is logged in
		When The user should pick moon option from dropdown
		When The user enters a "<Valid Moonname>"
		When The user enters a "<Valid PlanetId>"
	...
	a moon name without an image user should still be able to add to database
		Given The user is logged in
		When The user should pick moon option from dropdown
		When The user enters a "<Valid Moonname>"
		When The user enters a "<Valid PlanetId>"
	...
	a moon name longer than 30 characters, a user should not be able to add a new moon
		Given The user is logged in
		When The user should pick moon option from dropdown
	...
	a non-unique moon name, a user should not be able to add a new moon
		Given The user is logged in
		When The user should pick moon option from dropdown
		When The user enters a "<Invalid Moonname>"
		When The user enters a "<Valid PlanetId>"
	...
	an empty moon name, a user should not be able to add a new moon
		...
		Examples:
			| Valid PlanetId | Valid MoonImage |
			| 1              | moon-1.jpg      |

	@REV-TC-34 @JREQ-REV-78 @JREQ-REV-50
	Scenario Outline: Negative Scenario Invalid image format
	a valid moon name and an invalid image format, a user should not be able to add a new moon
